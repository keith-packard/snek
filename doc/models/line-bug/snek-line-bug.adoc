 ...
 * Sensor values will depend on light reflected from the surfaces
   ...
   your program less sensitive to this, shine consistent light with
   the LED.
...
Values for the white board are around 0.9, values for the black tape
are near 0.3. A reasonable threshold would be about halfway between, or
0.6. Code to detect the difference could be as simple as this:
...
Connect the light sensor to A1 and the light to A8. Make sure you
...
Attach the light sensor and light to the front of the line-bug using
the Light Gray 2 x 2 Bracket.
