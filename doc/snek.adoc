...
power to zero, values greater than one set the power to one.
...
to make it more compatible with Python curses.
...
Snek, such as the Duemilanove and Metro M0 Express boards.
