...
The Assert statement is used to add debugging information to a program.
When the expression passed to assert returns `False`, the program will
print `AssertionError` and you will know that the condition you expected
to be true is not.
